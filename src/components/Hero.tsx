...
const Hero = () => {
  ...
  return (
    <section ref={heroRef} className="relative min-h-screen flex items-center justify-center overflow-hidden px-4 py-24 parallax-section">
      {/* Animated background layers with parallax */}
      <div className="absolute inset-0 parallax-layer">
        <div className="absolute inset-0 hidden dark:block bg-gradient-space opacity-95" />
        <div className="absolute inset-0 dark:hidden bg-[linear-gradient(180deg,hsl(var(--background))_0%,hsl(var(--background)/0.6)_40%,hsl(var(--card)/0.4)_100%)]" />
      </div>
      ...
      <div className="relative z-10 max-w-6xl mx-auto text-center space-y-8 animate-fade-in hero-content">
        ...
        <h1 className="text-4xl md:text-7xl lg:text-8xl font-bold tracking-tight animate-in">
          <span className="bg-gradient-to-r from-primary via-secondary to-accent bg-clip-text text-transparent drop-shadow-sm dark:glow-text">
            Impact Watch Nexus
          </span>
        </h1>
